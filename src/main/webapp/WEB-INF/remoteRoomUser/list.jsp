...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="remoteRoomUser/page/add/"
				target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="remoteRoomUser//delete/{sid_user}/"
				target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="remoteRoomUser/page/edit/{sid_user}/"
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="120" align="center">用户号</th>
				<th width="120" align="center">用户名称</th>
				<th width="120" align="center">卡号</th>
				<th width="120" align="center">用户身份</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="ruser" items="${rusers}">
				<tr target="sid_user" rel="${ruser.id}">
					<td>${ruser.id}</td>
					<td>${ruser.userid}</td>
					<td>${ruser.username}</td>
					<td>${ruser.cardid}</td>
					<td>${ruser.userIdentity}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
